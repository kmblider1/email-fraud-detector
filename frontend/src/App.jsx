...
// ═══ TARJIMALAR ═══════════════════════════════════════════
const T={uz:{appName:"FraudGuard",appSub:"Email Firibgarlik Aniqlash Tizimi",login:"Kirish",loginBtn:"Kirish →",register:"Ro'yxatdan o'tish",registerBtn:"Ro'yxatdan o'tish →",noAccount:"Hisobingiz yo'qmi?",hasAccount:"Hisobingiz bormi?",username:"Foydalanuvchi nomi",password:"Parol",email:"Email",signUp:"Ro'yxatdan o'ting",signIn:"Kirish",dashboard:"Dashboard",checker:"Tekshirish",history:"Tarix",admin:"Admin",modelStatus:"Model holati",modelActive:"Random Forest · faol",totalChecks:"Jami tekshiruv",fraud:"Firibgar",legit:"Normal",fraudRate:"Firibgar ulush",riskDist:"Xavf darajasi",modelMetrics:"Model ko'rsatkichlari",recentChecks:"So'nggi tekshiruvlar",emailCheck:"Email Tekshirish",emailCheckSub:"Metama'lumotlarni kiriting",inputData:"Ma'lumotlar",checkBtn:"Tekshirish",analyzing:"Tahlil qilinmoqda...",resultEmpty:"Natija bu yerda ko'rinadi",rfAnalyzing:"Random Forest tahlil qilmoqda...",fraudDetected:"FIRIBGAR EMAIL!",normalEmail:"NORMAL EMAIL",fraudProb:"Firibgarlik ehtimoli",riskFactors:"Asosiy xavf omillari",confidence:"Ishonchlilik",high:"Yuqori",medium:"O'rta",low:"Past",historySub:"yozuv",histEmail:"Email / Domain",result:"Natija",probability:"Ehtimollik",risk:"Xavf",date:"Sana",fraudLabel:"Firibgar",legitLabel:"Normal",adminSub:"Boshqaruv",users:"Foydalanuvchilar",role:"Rol",checks:"Tekshiruv",status:"Holat",action:"Amal",active:"Faol",blocked:"Bloklangan",block:"Bloklash",unblock:"Ochish",logout:"Chiqish",totalUsers:"Foydalanuvchilar",language:"Til",yes:"Ha",no:"Yo'q",loading:"Yuklanmoqda...",loginError:"Login xato",noData:"Ma'lumot yo'q",dailyTrend:"Kunlik tendensiya",featImportance:"Xususiyat ahamiyati",fraudVsLegit:"Nisbat",riskChart:"Xavf darajalari",fields:{sender_email:"Yuboruvchi email",sender_domain:"Domain",sender_domain_age_days:"Domain yoshi (kun)",sender_reputation_score:"Yuboruvchi obro'si",num_recipients:"Qabul qiluvchilar",num_links_in_body:"Havolalar soni",num_suspicious_links:"Shubhali havolalar",body_length:"Xabar uzunligi",html_to_text_ratio:"HTML/matn nisbati",sending_hour:"Yuborish soati",header_anomaly_score:"Sarlavha anomaliyasi",ip_reputation_score:"IP obro'si",attachment_count:"Biriktirma soni",has_spf_record:"SPF yozuvi",has_dkim_signature:"DKIM imzosi",has_dmarc_policy:"DMARC siyosati",has_reply_to_mismatch:"Reply-To noto'g'ri",subject_has_urgent_words:"Shoshilinch sarlavha",has_executable_attachment:".exe fayl"}},ru:{appName:"FraudGuard",appSub:"Система обнаружения мошенничества",login:"Вход",loginBtn:"Войти →",register:"Регистрация",registerBtn:"Зарегистрироваться →",noAccount:"Нет аккаунта?",hasAccount:"Есть аккаунт?",username:"Имя пользователя",password:"Пароль",email:"Email",signUp:"Зарегистрироваться",signIn:"Войти",dashboard:"Панель",checker:"Проверка",history:"История",admin:"Админ",modelStatus:"Статус модели",modelActive:"Random Forest · активен",totalChecks:"Всего проверок",fraud:"Мошенников",legit:"Нормальных",fraudRate:"Доля мошенников",riskDist:"Распределение рисков",modelMetrics:"Показатели модели",recentChecks:"Последние проверки",emailCheck:"Проверка Email",emailCheckSub:"Введите метаданные",inputData:"Данные",checkBtn:"Проверить",analyzing:"Анализируется...",resultEmpty:"Результат появится здесь",rfAnalyzing:"Random Forest анализирует...",fraudDetected:"МОШЕННИЧЕСКИЙ EMAIL!",normalEmail:"НОРМАЛЬНЫЙ EMAIL",fraudProb:"Вероятность мошенничества",riskFactors:"Факторы риска",confidence:"Достоверность",high:"Высокая",medium:"Средняя",low:"Низкая",historySub:"записей",histEmail:"Email / Домен",result:"Результат",probability:"Вероятность",risk:"Риск",date:"Дата",fraudLabel:"Мошенник",legitLabel:"Нормальный",adminSub:"Управление",users:"Пользователи",role:"Роль",checks:"Проверок",status:"Статус",action:"Действие",active:"Активен",blocked:"Заблокирован",block:"Блокировать",unblock:"Разблокировать",logout:"Выйти",totalUsers:"Пользователей",language:"Язык",yes:"Да",no:"Нет",loading:"Загрузка...",loginError:"Неверный логин",noData:"Нет данных",dailyTrend:"Дневной тренд",featImportance:"Важность признаков",fraudVsLegit:"Соотношение",riskChart:"Уровни риска",fields:{sender_email:"Email отправителя",sender_domain:"Домен",sender_domain_age_days:"Возраст домена (дни)",sender_reputation_score:"Репутация отправителя",num_recipients:"Получателей",num_links_in_body:"Ссылок",num_suspicious_links:"Подозрительных ссылок",body_length:"Длина сообщения",html_to_text_ratio:"HTML/текст",sending_hour:"Час отправки",header_anomaly_score:"Аномалия заголовка",ip_reputation_score:"Репутация IP",attachment_count:"Вложений",has_spf_record:"Запись SPF",has_dkim_signature:"Подпись DKIM",has_dmarc_policy:"Политика DMARC",has_reply_to_mismatch:"Reply-To несовпадение",subject_has_urgent_words:"Срочные слова",has_executable_attachment:".exe файл"}},en:{appName:"FraudGuard",appSub:"Email Fraud Detection System",login:"Login",loginBtn:"Sign In →",register:"Register",registerBtn:"Create Account →",noAccount:"No account?",hasAccount:"Have account?",username:"Username",password:"Password",email:"Email",signUp:"Sign Up",signIn:"Sign In",dashboard:"Dashboard",checker:"Checker",history:"History",admin:"Admin",modelStatus:"Model Status",modelActive:"Random Forest · active",totalChecks:"Total Checks",fraud:"Fraud",legit:"Legitimate",fraudRate:"Fraud Rate",riskDist:"Risk Distribution",modelMetrics:"Model Performance",recentChecks:"Recent Checks",emailCheck:"Email Checker",emailCheckSub:"Enter metadata to analyze",inputData:"Input Data",checkBtn:"Check",analyzing:"Analyzing...",resultEmpty:"Result will appear here",rfAnalyzing:"Random Forest is analyzing...",fraudDetected:"FRAUDULENT EMAIL!",normalEmail:"LEGITIMATE EMAIL",fraudProb:"Fraud Probability",riskFactors:"Top Risk Factors",confidence:"Confidence",high:"High",medium:"Medium",low:"Low",historySub:"records",histEmail:"Email / Domain",result:"Result",probability:"Probability",risk:"Risk",date:"Date",fraudLabel:"Fraud",legitLabel:"Legitimate",adminSub:"Management",users:"Users",role:"Role",checks:"Checks",status:"Status",action:"Action",active:"Active",blocked:"Blocked",block:"Block",unblock:"Unblock",logout:"Logout",totalUsers:"Users",language:"Language",yes:"Yes",no:"No",loading:"Loading...",loginError:"Invalid login",noData:"No data",dailyTrend:"Daily Trend",featImportance:"Feature Importance",fraudVsLegit:"Ratio",riskChart:"Risk Levels",fields:{sender_email:"Sender Email",sender_domain:"Domain",sender_domain_age_days:"Domain Age (days)",sender_reputation_score:"Sender Reputation",num_recipients:"Recipients",num_links_in_body:"Links",num_suspicious_links:"Suspicious Links",body_length:"Body Length",html_to_text_ratio:"HTML/Text Ratio",sending_hour:"Sending Hour",header_anomaly_score:"Header Anomaly",ip_reputation_score:"IP Reputation",attachment_count:"Attachments",has_spf_record:"SPF Record",has_dkim_signature:"DKIM Signature",has_dmarc_policy:"DMARC Policy",has_reply_to_mismatch:"Reply-To Mismatch",subject_has_urgent_words:"Urgent Subject",has_executable_attachment:".exe Attachment"}}};

const LANGS=[{code:"uz",flag:"🇺🇿"},{code:"ru",flag:"🇷🇺"},{code:"en",flag:"🇬🇧"}];
...
export default function App(){
  ...
  if(auth!=="app")return(
    <div style={S.wrap}><div style={S.bg}/>
      ...
      <div style={S.card}>
        <div style={{textAlign:"center",fontSize:48,marginBottom:6}}>{auth==="login"?"🛡️":"📝"}</div>
  ...
  const nav=[{id:"dashboard",icon:"◈",label:t.dashboard},{id:"checker",icon:"⬡",label:t.checker},{id:"history",icon:"◷",label:t.history},...(user?.role==="admin"?[{id:"admin",icon:"⬢",label:t.admin}]:[])];
    ...
    <div style={{display:"flex",minHeight:"100vh",background:"#020617",fontFamily:"'Courier New',monospace"}}>
      <aside style={{width:224,background:"#0a0f1e",borderRight:"1px solid #0f2240",display:"flex",flexDirection:"column",padding:"1.2rem 0.8rem",gap:6}}>
        ...
        <div style={{background:"#0f172a",borderRadius:10,padding:12,border:"1px solid #0f2240",margin:"8px 0"}}>
          ...
          <div style={{color:"#334155",fontSize:10,marginTop:3}}>F1: 96.9% · AUC: 99.4%</div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,padding:"12px 8px",borderTop:"1px solid #0f2240",marginTop:4}}>
          ...
          <button style={{marginLeft:"auto",background:"none",border:"none",color:"#334155",cursor:"pointer",fontSize:16}} onClick={doLogout} title={t.logout}>⏻</button>
        </div>
      </aside>
...
function Dash({t,token}){
  ...
  if(ld)return<div style={{color:"#94a3b8",padding:60,textAlign:"center",fontSize:16}}>⏳ {t.loading}</div>;
  ...
  return(<div style={{padding:"1.5rem",maxWidth:1200,margin:"0 auto"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,marginBottom:20}}>
      {[{i:"📬",l:t.totalChecks,v:st.total_checks,c:"#38bdf8"},{i:"🚨",l:t.fraud,v:st.fraud_count,c:"#f43f5e"},{i:"✅",l:t.legit,v:st.legit_count,c:"#22c55e"},{i:"📊",l:t.fraudRate,v:`${st.fraud_rate}%`,c:"#f59e0b"}].map(({i,l,v,c})=>(
    ...
    <div style={{display:"grid",gridTemplateColumns:"1.6fr 1fr",gap:16,marginBottom:16}}>
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>📈 {t.dailyTrend}</div>
      ...
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>🍩 {t.fraudVsLegit}</div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1.2fr",gap:16,marginBottom:16}}>
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>⚠️ {t.riskChart}</div>
      ...
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>🔑 {t.featImportance}</div>
        <ResponsiveContainer width="100%" height={180}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1.5fr",gap:16}}>
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>🤖 {t.modelMetrics}</div>
      ...
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>🕐 {t.recentChecks}</div>
        {h.length===0&&<div style={{color:"#475569",padding:20,textAlign:"center"}}>{t.noData}</div>}
        {h.map(x=>(<div key={x.id} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid #0f172a"}}><span style={{fontSize:18}}>{x.is_fraud?"🚨":"✅"}</span><div style={{flex:1}}><div style={{color:"#cbd5e1",fontSize:13,fontWeight:600}}>{x.sender_email||x.sender_domain||`#${x.id}`}</div><div style={{color:"#475569",fontSize:11}}>{new Date(x.checked_at).toLocaleString()}</div></div><span style={{padding:"3px 10px",borderRadius:20,fontSize:11,fontWeight:700,color:RC[x.risk_level],background:RC[x.risk_level]+"22"}}>{x.risk_level}</span><span style={{color:x.is_fraud?"#f43f5e":"#22c55e",fontWeight:700,fontSize:13,width:50,textAlign:"right"}}>{(x.fraud_probability*100).toFixed(0)}%</span></div>))}
      </div>
    </div>
  </div>);
}
...
function Check({t,form,setForm,result,checking,onCheck}){
  ...
  return(<div style={{padding:"1.5rem",maxWidth:1100,margin:"0 auto"}}>
    <div style={{marginBottom:24,display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
      <div><h2 style={{color:"#f1f5f9",fontSize:20,fontWeight:800,margin:0}}>📧 {t.emailCheck}</h2><p style={{color:"#475569",fontSize:13,margin:"4px 0 0"}}>{t.emailCheckSub}</p></div>
      <div style={{display:"flex",gap:4,background:"#0f172a",padding:4,borderRadius:10,border:"1px solid #0f2240"}}>
        {[{id:"manual",icon:"✏️",label:"Qo'lda"},{id:"header",icon:"📋",label:"Header paste"},{id:"gmail",icon:"📨",label:"Gmail API"}].map(tb=>(
    ...
    {tab==="header"&&(
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
        <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
          <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>📋 Email Header</div>
          <div style={{color:"#475569",fontSize:11,marginBottom:12}}>
            Gmail → Email oching → ⋮ (3 nuqta) → <strong style={{color:"#38bdf8"}}>"Asl nusxasini ko'rish"</strong> → Hammasini nusxalab bu yerga yapishiring
          </div>
          ...
          <button onClick={handleParse} disabled={!rawHeader.trim()} style={{width:"100%",marginTop:12,padding:12,borderRadius:8,border:"none",background:rawHeader.trim()?"linear-gradient(135deg,#1d4ed8,#1e40af)":"#0f172a",color:rawHeader.trim()?"#fff":"#334155",fontWeight:700,fontSize:13,cursor:rawHeader.trim()?"pointer":"not-allowed",transition:"all 0.2s"}}>
            {parsed?"✅ Tahlil qilindi! Qo'lda tabiga o'tdi":"🔍 Headerdan ma'lumot olish"}
          </button>
        </div>
        <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #1e3a5f"}}>
          <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>📖 Qanday ishlatish</div>
          {[
            {step:"1",title:"Gmail ni oching",desc:"Shubhali email ni toping"},
            {step:"2",title:"3 nuqtani bosing",desc:"Email o'ng yuqorisidagi ⋮ belgisi"},
          ...
          <div style={{marginTop:16,padding:12,background:"#0f2240",borderRadius:8,border:"1px solid #1e3a5f"}}>
            <div style={{color:"#38bdf8",fontSize:11,fontWeight:700,marginBottom:6}}>⚡ Avtomatik aniqlanadi:</div>
            <div style={{color:"#475569",fontSize:11,lineHeight:1.8}}>✓ Yuboruvchi email va domain<br/>✓ SPF / DKIM / DMARC<br/>✓ Yuborish vaqti<br/>✓ Shubhali havolalar<br/>✓ Biriktirma va .exe fayl<br/>✓ Shoshilinch so'zlar</div>
          </div>
        </div>
      </div>
    )}
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
        <div style={{background:"#0a0f1e",borderRadius:12,padding:24,border:"1px solid #0f2240"}}>
          ...
          <div style={{background:"#0f172a",borderRadius:10,padding:16,border:"1px solid #1e3a5f",marginBottom:16}}>
            <div style={{color:"#f59e0b",fontSize:12,fontWeight:700,marginBottom:8}}>⚠️ O'rnatish kerak:</div>
            <div style={{color:"#64748b",fontSize:11,lineHeight:2}}>
              1. Google Cloud Console → yangi loyiha<br/>
          ...
          <button onClick={()=>window.open("https://console.cloud.google.com/","_blank")} style={{width:"100%",padding:12,borderRadius:8,border:"1px solid #1d4ed8",background:"transparent",color:"#38bdf8",fontWeight:700,fontSize:13,cursor:"pointer",marginBottom:8}}>
            🌐 Google Cloud Console ni ochish
          </button>
          <button onClick={()=>alert("Gmail API sozlanmagan. Avval Google Cloud Console da OAuth credentials yarating!")} style={{width:"100%",padding:12,borderRadius:8,border:"none",background:"linear-gradient(135deg,#ea4335,#c5221f)",color:"#fff",fontWeight:700,fontSize:13,cursor:"pointer"}}>
            📨 Gmail bilan bog'lanish
          </button>
        </div>
        <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
          <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>📖 Gmail API sozlash</div>
          {[
            {step:"1",title:"Google Cloud Console",desc:"console.cloud.google.com ga kiring",color:"#38bdf8"},
            {step:"2",title:"Yangi loyiha yarating",desc:"'New Project' → 'FraudGuard' deb nomlang",color:"#a78bfa"},
            {step:"3",title:"Gmail API yoqing",desc:"APIs & Services → Enable APIs → Gmail API",color:"#22c55e"},
            {step:"4",title:"OAuth yarating",desc:"Credentials → Create → OAuth 2.0 Client ID",color:"#f59e0b"},
          ...
          <div style={{marginTop:8,padding:12,background:"#052e16",borderRadius:8,border:"1px solid #166534"}}>
            <div style={{color:"#22c55e",fontSize:11,fontWeight:700}}>💡 Maslahat</div>
            <div style={{color:"#475569",fontSize:11,marginTop:4}}>Gmail API murakkab. Dissertatsiya uchun <strong style={{color:"#38bdf8"}}>"Header paste"</strong> usuli tavsiya etiladi — tezroq va soddaroq!</div>
          </div>
        </div>
      </div>
    )}
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>📋 {t.inputData}</div>
        ...
        <button style={{width:"100%",padding:14,borderRadius:10,border:"none",background:"linear-gradient(135deg,#1d4ed8,#1e40af)",color:"#fff",fontWeight:700,fontSize:14,cursor:"pointer",opacity:checking?0.7:1}} onClick={onCheck} disabled={checking}>
          {checking?<span style={{display:"flex",alignItems:"center",gap:8,justifyContent:"center"}}><Spin/>{t.analyzing}</span>:`🔍 ${t.checkBtn}`}
        </button>
      </div>
      <div>
        {!result&&!checking&&<div style={{height:460,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#0a0f1e",borderRadius:12,border:"1px dashed #0f2240"}}><div style={{fontSize:52,marginBottom:12}}>🔍</div><div style={{color:"#475569",fontSize:14}}>{t.resultEmpty}</div></div>}
        {checking&&<div style={{height:460,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#0a0f1e",borderRadius:12,border:"1px dashed #0f2240"}}><div style={{fontSize:44,marginBottom:12,animation:"spin2 1s linear infinite"}}><style>{`@keyframes spin2{to{transform:rotate(360deg)}}`}</style>⚙️</div><div style={{color:"#94a3b8"}}>{t.rfAnalyzing}</div></div>}
        {result&&(<div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:`2px solid ${RC[result.risk_level]}88`}}>
          <div style={{textAlign:"center",paddingBottom:20,borderBottom:"1px solid #1e293b",marginBottom:20}}><div style={{fontSize:52,marginBottom:8}}>{result.is_fraud?"🚨":"✅"}</div><div style={{fontSize:20,fontWeight:800,color:result.is_fraud?"#f43f5e":"#22c55e",marginBottom:6}}>{result.is_fraud?t.fraudDetected:t.normalEmail}</div><span style={{padding:"4px 16px",borderRadius:20,fontSize:12,fontWeight:700,color:RC[result.risk_level],background:RC[result.risk_level]+"22",border:`1px solid ${RC[result.risk_level]}`}}>{result.risk_level}</span></div>
          ...
          {result.top_risk_factors?.length>0&&(
            <div>
              <div style={{color:"#f59e0b",fontWeight:700,fontSize:13,marginBottom:10}}>⚠️ {t.riskFactors}</div>
          ...
          <div style={{marginTop:16,paddingTop:12,borderTop:"1px solid #1e293b",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <button onClick={async()=>{
              ...
              const flds=[["Yuboruvchi email",String(result.sender_email||"—")],["Domain",String(result.sender_domain||"—")],["IP obro'si",String(result.ip_reputation_score||"—")],["Shubhali havolalar",String(result.num_suspicious_links||"—")]];
...
function Hist({t,token}){
  ...
  return(<div style={{padding:"1.5rem",maxWidth:1000,margin:"0 auto"}}>
    <div style={{marginBottom:24}}><h2 style={{color:"#f1f5f9",fontSize:20,fontWeight:800,margin:0}}>📋 {t.history}</h2><p style={{color:"#475569",fontSize:13,margin:"4px 0 0"}}>{data?.total||0} {t.historySub}</p></div>
    {ld&&<div style={{color:"#94a3b8",padding:40,textAlign:"center"}}>⏳ {t.loading}</div>}
    {!ld&&data&&(<>
      <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
        ...
        {data.items.map(h=>(<div key={h.id} style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr 1fr",padding:"12px 16px",borderBottom:"1px solid #0f172a",alignItems:"center",fontSize:13}}><div><div style={{color:"#cbd5e1",fontSize:13,fontWeight:600}}>{h.sender_email||`#${h.id}`}</div><div style={{color:"#334155",fontSize:11}}>{h.sender_domain}</div></div><span style={{color:h.is_fraud?"#f43f5e":"#22c55e",fontWeight:700}}>{h.is_fraud?`🚨 ${t.fraudLabel}`:`✅ ${t.legitLabel}`}</span><span style={{color:RC[h.risk_level],fontWeight:700,fontFamily:"monospace",fontSize:14}}>{(h.fraud_probability*100).toFixed(0)}%</span><span style={{padding:"3px 10px",borderRadius:20,fontSize:11,fontWeight:700,color:RC[h.risk_level],background:RC[h.risk_level]+"22",width:"fit-content"}}>{h.risk_level}</span><span style={{color:"#475569",fontSize:12}}>{new Date(h.checked_at).toLocaleDateString()}</span></div>))}
      </div>
      <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:16,marginTop:16}}>
        <button style={{padding:"8px 16px",borderRadius:8,border:"1px solid #334155",background:"#1e293b",color:"#f1f5f9",cursor:"pointer"}} onClick={()=>setPg(p=>p-1)} disabled={pg===0}>← Oldingi</button>
        <span style={{color:"#94a3b8"}}>Sahifa {pg+1}</span>
        <button style={{padding:"8px 16px",borderRadius:8,border:"1px solid #334155",background:"#1e293b",color:"#f1f5f9",cursor:"pointer"}} onClick={()=>setPg(p=>p+1)} disabled={(pg+1)*L>=data.total}>Keyingi →</button>
      </div>
    </>)}
  </div>);
}
...
function Adm({t,token}){
  ...
  if(ld)return<div style={{color:"#94a3b8",padding:60,textAlign:"center"}}>⏳ {t.loading}</div>;
  return(<div style={{padding:"1.5rem",maxWidth:1000,margin:"0 auto"}}>
    <div style={{marginBottom:24}}><h2 style={{color:"#f1f5f9",fontSize:20,fontWeight:800,margin:0}}>🛠️ {t.admin}</h2><p style={{color:"#475569",fontSize:13,margin:"4px 0 0"}}>{t.adminSub}</p></div>
    ...
    <div style={{background:"#0a0f1e",borderRadius:12,padding:20,border:"1px solid #0f2240"}}>
      <div style={{color:"#94a3b8",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:16}}>👥 {t.users}</div>
